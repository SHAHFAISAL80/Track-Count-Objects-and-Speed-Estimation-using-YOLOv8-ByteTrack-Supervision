...
# getting Video1860079
cap = cv2.VideoCapture(r"C:\Users\x\Videos\Track-Count-Objects-and-Speed-Estimation-using-YOLOv8-ByteTrack-Supervision-main\Track-Count-Objects-and-Speed-Estimation-using-YOLOv8-ByteTrack-Supervision-main\re.mp4") #0 and 1 webcam
...
model = YOLO(r"C:\Users\x\Videos\Track-Count-Objects-and-Speed-Estimation-using-YOLOv8-ByteTrack-Supervision-main\Track-Count-Objects-and-Speed-Estimation-using-YOLOv8-ByteTrack-Supervision-main\yolov8n.pt")
...
while True:
    ...
    results = model.track(frame, conf=0.3, imgsz=(3840, 2176),
                          persist=True, classes=[2, 7], tracker=r"C:\Users\x\Videos\Track-Count-Objects-and-Speed-Estimation-using-YOLOv8-ByteTrack-Supervision-main\Track-Count-Objects-and-Speed-Estimation-using-YOLOv8-ByteTrack-Supervision-main\bytetrack.yaml", verbose=False)
